...
public class PutRequest2 {
	...
	public static void main(String[] args) {
		...
		String xmlBody= "<Laptop>"
			   ...
			   +  	"<Feature>5TB Hard Drive</Feature>"
			   +  	"<Feature>4 GB NVIDIA</Feature>"
			   + "</Features>"
			   + "<Id>132</Id>"
		...
		RestResponse response= RestApiHelper.performPutRequest("http://localhost:9090/laptop-bag/webapi/api/update", xmlBody, ContentType.APPLICATION_XML, headers);
